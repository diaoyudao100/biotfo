          ...
          <div class="flex items-center space-x-4">
            ...
            <template v-if="authStore.isLoggedIn">
              ...
              <NuxtLink
                ...
                to="/admin"
                class="hidden sm:inline-flex items-center px-2.5 py-1 text-xs font-medium text-indigo-600 bg-indigo-50 rounded-full hover:bg-indigo-100 transition-colors"
              >
        ...
        <div v-if="mobileMenuOpen" class="md:hidden pb-4 border-t border-gray-100 pt-3">
          ...
          <nav class="flex flex-col space-y-2">
            ...
            <NuxtLink
              ...
              to="/admin"
              class="px-3 py-2 rounded-lg text-indigo-600 hover:bg-indigo-50 font-medium"
              @click="mobileMenuOpen = false"
            >
              管理后台
            </NuxtLink>
